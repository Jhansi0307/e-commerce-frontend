...
function Checkout1() {
  ...
  <div className="PaymentForm d-flex justify-content-center mt-5 ">
    ...
    <button className="mb-3 mt-3 btn btn-primary">Book securely</button><br></br>
    <span>
      <i className="fa fa-fw fa-lock mb-3 mt-3" /> Your credit card information is
      encrypted
    </span>
  </div>
      </div>
<Link to="/userhome">
      <button className="mb-3 mt-3 btn btn-warning">Back to Shopping</button>
      </Link>
    </form>
  </div>
